...
/* Additions CPqD */
#define DECL_FUNC(funcname, cmdname)                                        \
      int funcname (struct cmd_element *, struct vty *vty, int, const char **);   \
      extern struct cmd_element cmdname;


#define IMPL_FUNC(funcname, cmdname, cmdstr, helpstr) \
      ...
      int funcname (struct cmd_element *self, struct vty *vty, int argc, const char **argv)
