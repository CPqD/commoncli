...
#define QUAGGA_PROGNAME   "CLI Based on Quagga/Zebra"

#define QUAGGA_VERSION     "2.0.0" GIT_SUFFIX

#define ZEBRA_BUG_ADDRESS "https://gerrit.cpqd.com.br/#/admin/projects/vppd/shared/libcommoncli"
