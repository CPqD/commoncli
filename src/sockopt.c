			...
			unsigned int ifindex)
{
  ...
  // Example defines for another OS, boilerplate off other code in this function, AND handle optname as per other sections for consistency !!
			...
			unsigned int ifindex)
{
  ...
  // Example defines for another OS, boilerplate off other code in this   function
  // #elif  defined(BOGON_NIX) && EXAMPLE_VERSION_CODE > -100000 *
  // Add your favourite OS here!
